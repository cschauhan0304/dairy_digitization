...
<body>
    <div style="margin-top: 100px;">
        ...
        <div class="category-container">
            <div class="category-card" onclick="showCategory('Dairy Milk')">Dairy Milk</div>
            <div class="category-card" onclick="showCategory('Non Dairy Milk')">Non Dairy Milk</div>
            <div class="category-card" onclick="showCategory('Dairy Products')">Dairy Products</div>
        </div>
    ...
    %>
                <tr>
                    ...
                    <td><img src="img/Milk.jpg" alt="Image Description" width="100" height="100"></td>
