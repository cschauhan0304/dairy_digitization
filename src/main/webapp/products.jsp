...
<style>
    ...
    function loadProductImages() {
        ...
        // Iterate over each row and load images asynchronously
        rows.each(function () {
            var productName = $(this).find("td:eq(1)").text();
            var img = new Image();
            //img.src = "img/" + productName + ".jpg";
            ...
            // Replace the existing empty cell with the new cell containing the image
            $(this).find("td:eq(2)").replaceWith(imgCell);
        });
    }

    // Function to handle page load and initiate image loading
